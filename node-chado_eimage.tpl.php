<?php
// Purpose: This template provides the layout of the eimage node (page)
//   using the same templates used for the various eimage content blocks.
//
...
if (is_array($template_settings['tripal_no_sidebar']) and 
   $template_settings['tripal_no_sidebar']['eimage']) {
  $no_sidebar = 1;
}
